...
public class ReporteController {
    ...
    @GetMapping("/existenciasTotales")
    public ResponseEntity<Resource> reporteExistenciasTotales(@RequestParam String tipo) throws IOException {
        return reporteService.generaReporte("existenciasTotales", null, tipo);
